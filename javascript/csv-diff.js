...
function exportImage() {
	var el = document.getElementById("result-csv-diff");
	...
	el.style.overflow = 'visible'; // Make overflow content visible temporarily
    html2canvas(el,  {
		scale:2,
		...
		a.download = filename;
		a.click();
		el.style.overflow = originalOverflow; // Restore original overflow style
	  });
}
